...
import { AppDialog, LatexEditor, PdfPreviewPanel } from "../ui";
...
export function BaseLatexTemplateDialog({
  ...
  const {
    ...
    collapseLeftPane,
    collapseRightPane,
  } = useResizableSplitPane({ disabled: isLoadingTemplate });
  ...
  return (
    <AppDialog
      open={open}
      onClose={onClose}
      title={t("baseTemplate.title")}
      fullWidth
      maxWidth="xl"
      contentDividers
      actionsSx={{ px: 3, py: 2, gap: 1 }}
      actions={
        <>
